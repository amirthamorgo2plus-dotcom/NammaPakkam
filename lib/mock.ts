...
export const MOCK_COMMUNITIES: Community[] = [
  { id: 'm', slug: 'pakkam', name: 'Purva', city: 'Coimbatore', blocks: MOCK_BLOCKS, image_url: null, homes: 1000, status: 'active', theme: 'from-brand-400 to-brand-600', emoji: '🏡' },
  { id: 'm2', slug: 'green-meadows', name: 'Green Meadows', city: 'Coimbatore', blocks: ['A', 'B', 'C'], image_url: null, homes: 480, status: 'coming_soon', theme: 'from-lav-400 to-lav-600', emoji: '🌿' },
  { id: 'm3', slug: 'lake-view', name: 'Lake View Residency', city: 'Chennai', blocks: ['1', '2', '3', '4'], image_url: null, homes: 720, status: 'coming_soon', theme: 'from-pink-400 to-brand-500', emoji: '🌊' },
];
